...
Report as undeclared any location data collected or transmitted off-device (outside exclusions) not declared in DSS.
  ...
  "omitted_declarations": [
    {
      ...
      "policy_reference": "Full unmodified paragraph from Privacy Policy where location collection is explicitly declared, including recipient and purpose context.",
      "lang": "English"
    }
  ]
}
...
for model_name in models_to_try:
    ...
    while True:  
        try:
            ...
            output_file = os.path.join(output_dir, f"{packageName}_CollectionPersonalInfo.json")
